...
library(ggplot2)
library(data.table)
load("/net/mulan/home/yasheng/Biobank/code/figures/simulation/t_summary_result.RData")
...
mse_SLM_plt <- ggplot(mse_SLM_dat, aes(x=Method, y=MSE, fill=Method))+
  ...
  facet_wrap_custom(~heritability, scales = "free", ncol = 1, scale_overrides = list(
    ...
    scale_override(2, scale_y_continuous(breaks = seq(0, 20, 5), limits = c(0, 20))), 
    scale_override(3, scale_y_continuous(breaks = seq(0, 400, 100), limits = c(0, 415)))
  ))+
  stat_summary(fun.y = mean, colour = "black", geom="text", show_guide = FALSE, 
...
mse_LMM_plt <- ggplot(mse_LMM_dat, aes(x=Method, y=MSE, fill=Method))+
  ...
  geom_boxplot(width=0.7, position=position_dodge(0.8))+
  facet_wrap_custom(~heritability, scales = "free", ncol = 1, scale_overrides = list(
    scale_override(1, scale_y_continuous(breaks = seq(0, 2000, 500), limits = c(0, 2000))), 
    scale_override(2, scale_y_continuous(breaks = seq(0, 28, 7), limits = c(0, 28))), 
    scale_override(3, scale_y_continuous(breaks = seq(0, 120, 30), limits = c(0, 120)))
  ))+
  stat_summary(fun.y = mean, colour = "black", geom="text", show_guide = FALSE, 
               vjust = -2, aes(label=round(..y.., digits=3)), size = 10) +
  scale_fill_manual(values=as.character(col_dat[, 1]))+
...
mse_SLMM_plt1 <- ggplot(mse_SLMM_dat1, aes(x=Method, y=MSE, fill=Method))+
  geom_boxplot(width=0.7, position=position_dodge(0.8))+
  facet_wrap_custom(~heritability, scales = "free", ncol = 1, scale_overrides = list(
    scale_override(1, scale_y_continuous(breaks = seq(0, 1000, 250), limits = c(0, 1000))), 
    scale_override(2, scale_y_continuous(breaks = seq(0, 16, 4), limits = c(0, 16))), 
    scale_override(3, scale_y_continuous(breaks = seq(0, 80, 20), limits = c(0, 80)))
  ))+
  stat_summary(fun.y = mean, colour = "black", geom="text", show_guide = FALSE, 
               vjust = -2, aes(label=round(..y.., digits=3)), size = 10) +
  scale_fill_manual(values=as.character(col_dat[, 1]))+
...
mse_SLMM_plt2 <- ggplot(mse_SLMM_dat2, aes(x=Method, y=MSE, fill=Method))+
  geom_boxplot(width=0.7, position=position_dodge(0.8))+
  facet_wrap_custom(~heritability, scales = "free", ncol = 1, scale_overrides = list(
    scale_override(1, scale_y_continuous(breaks = seq(0, 4, 1), limits = c(0, 4))), 
    scale_override(2, scale_y_continuous(breaks = seq(0, 800, 200), limits = c(0, 800))), 
    scale_override(3, scale_y_continuous(breaks = seq(0, 80, 20), limits = c(0, 80)))
  ))+
  stat_summary(fun.y = mean, colour = "black", geom="text", show_guide = FALSE, 
               vjust = -2, aes(label=round(..y.., digits=3)), size = 10) +
...
library(patchwork)
tiff("/net/mulan/disk2/yasheng/figures/simulation/r2_t_herit0.1.tiff", height = 1200, width = 1600)
(r2_SLM_plt1 | r2_LMM_plt1) /
  (r2_SLMM_plt11 | r2_SLMM_plt21)
dev.off()
tiff("/net/mulan/disk2/yasheng/figures/simulation/r2_t_herit0.2.tiff", height = 1200, width = 1600)
(r2_SLM_plt2 | r2_LMM_plt2) /
  (r2_SLMM_plt12 | r2_SLMM_plt22)
dev.off()
tiff("/net/mulan/disk2/yasheng/figures/simulation/r2_t_herit0.5.tiff", height = 1200, width = 1600)
(r2_SLM_plt3 | r2_LMM_plt3) /
  (r2_SLMM_plt13 | r2_SLMM_plt23)
dev.off()

tiff("/net/mulan/disk2/yasheng/figures/simulation/mse_t.tiff", height = 1600, width = 2000)
