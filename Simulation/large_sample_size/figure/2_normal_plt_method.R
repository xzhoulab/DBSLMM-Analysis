...
library(ggplot2)
library(data.table)
load("/net/mulan/home/yasheng/Biobank/code/figures/simulation/normal_summary_result.RData")
...
mse_SLM_plt <- ggplot(mse_SLM_dat, aes(x=Method, y=MSE, fill=Method))+
  ...
  facet_wrap_custom(~heritability, scales = "free", ncol = 1, scale_overrides = list(
    scale_override(1, scale_y_continuous(breaks = seq(0, 6, 1.5), limits = c(0, 6))), 
    scale_override(2, scale_y_continuous(breaks = seq(0, 16, 4), limits = c(0, 16))), 
    scale_override(3, scale_y_continuous(breaks = seq(0, 60, 15), limits = c(0, 60)))
  ))+
  stat_summary(fun.y = mean, colour = "black", geom="text", show_guide = FALSE, 
               vjust = -4, aes(label=round(..y.., digits=3)), size = 10) +
...
mse_LMM_plt <- ggplot(mse_LMM_dat, aes(x=Method, y=MSE, fill=Method))+
  ...
  facet_wrap_custom(~heritability, scales = "free", ncol = 1, scale_overrides = list(
    ...
    scale_override(2, scale_y_continuous(breaks = seq(0, 880, 220), limits = c(0, 880))), 
    scale_override(3, scale_y_continuous(breaks = seq(0, 36, 5), limits = c(0, 37)))
  ))+
  stat_summary(fun.y = mean, colour = "black", geom="text", show_guide = FALSE, 
               vjust = -4, aes(label=round(..y.., digits=3)), size = 10) +
  scale_fill_manual(values=as.character(col_dat[, 1]))+
...
mse_SLMM_plt1 <- ggplot(mse_SLMM_dat1, aes(x=Method, y=MSE, fill=Method))+
  geom_boxplot(width=0.7, position=position_dodge(0.8))+
  facet_wrap_custom(~heritability, scales = "free", ncol = 1, scale_overrides = list(
    scale_override(1, scale_y_continuous(breaks = seq(0, 500, 125), limits = c(0, 500))), 
    scale_override(2, scale_y_continuous(breaks = seq(0, 1400, 350), limits = c(0, 1400))), 
    scale_override(3, scale_y_continuous(breaks = seq(0, 60, 15), limits = c(0, 61)))
  ))+
  stat_summary(fun.y = mean, colour = "black", geom="text", show_guide = FALSE, 
               vjust = -4, aes(label=round(..y.., digits=3)), size = 10) +
  scale_fill_manual(values=as.character(col_dat[, 1]))+
...
mse_SLMM_plt2 <- ggplot(mse_SLMM_dat2, aes(x=Method, y=MSE, fill=Method))+
  geom_boxplot(width=0.7, position=position_dodge(0.8))+
  facet_wrap_custom(~heritability, scales = "free", ncol = 1, scale_overrides = list(
    scale_override(1, scale_y_continuous(breaks = seq(0, 540, 135), limits = c(0, 540))), 
    scale_override(2, scale_y_continuous(breaks = seq(0, 6, 1.5), limits = c(0, 6))), 
...
library(patchwork)
tiff("/net/mulan/disk2/yasheng/figures/simulation/r2_normal_herit0.1.tiff", height = 1200, width = 1600)
(r2_SLM_plt1 | r2_LMM_plt1) /
  (r2_SLMM_plt11 | r2_SLMM_plt21)
dev.off()
tiff("/net/mulan/disk2/yasheng/figures/simulation/r2_normal_herit0.2.tiff", height = 1200, width = 1600)
(r2_SLM_plt2 | r2_LMM_plt2) /
  (r2_SLMM_plt12 | r2_SLMM_plt22)
dev.off()
tiff("/net/mulan/disk2/yasheng/figures/simulation/r2_normal_herit0.5.tiff", height = 1200, width = 1600)
(r2_SLM_plt3 | r2_LMM_plt3) /
  (r2_SLMM_plt13 | r2_SLMM_plt23)
dev.off()

tiff("/net/mulan/disk2/yasheng/figures/simulation/mse_normal.tiff", height = 1600, width = 2000)
