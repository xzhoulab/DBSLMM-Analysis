...
## Output
library(patchwork)
tiff("/net/mulan/disk2/yasheng/figures/simulation/diff_laplace_herit0.1.tiff", height = 1200, width = 1600)
(r2_SLM_diff_plt1 | r2_LMM_diff_plt1) /
  (r2_SLMM_diff_plt11 | r2_SLMM_diff_plt21)
dev.off()
tiff("/net/mulan/disk2/yasheng/figures/simulation/diff_laplace_herit0.2.tiff", height = 1200, width = 1600)
(r2_SLM_diff_plt2 | r2_LMM_diff_plt2) /
  (r2_SLMM_diff_plt12 | r2_SLMM_diff_plt22)
dev.off()
tiff("/net/mulan/disk2/yasheng/figures/simulation/diff_laplace_herit0.5.tiff", height = 1200, width = 1600)
