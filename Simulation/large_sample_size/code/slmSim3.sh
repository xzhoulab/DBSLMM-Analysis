...
#SBATCH --output=/net/mulan/disk2/yasheng/out/simSLM0_%a.out
#SBATCH --error=/net/mulan/disk2/yasheng/err/simSLM0_%a.err
...
slmPheno=/net/mulan/home/yasheng/Biobank/code/simulation/slmPheno3.R
...
bfile=/net/mulan/disk2/yasheng/simulation2/SLM/data/geno_her${herit}_cross${cross}_dist${dist}_ps${ps}
bfiletr=/net/mulan/disk2/yasheng/simulation2/SLM/data/train_her${herit}_cross${cross}_dist${dist}_ps${ps}
bfilete=/net/mulan/disk2/yasheng/simulation2/SLM/data/test_her${herit}_cross${cross}_dist${dist}_ps${ps}
...
## reference data
bfileval=/net/mulan/disk2/yasheng/simulation2/SLM/data/val_her${herit}_cross${cross}_dist${dist}_ps${ps}
...
## PT 
summf=/net/mulan/disk2/yasheng/simulation2/SLM/output/summary_her${herit}_cross${cross}_dist${dist}_ps${ps}
Rscript ${toplinkf} --gemma ${summf}.assoc.txt --plink ${summf}.plink.txt
clump1=/net/mulan/disk2/yasheng/simulation2/SLM/PT/summary_her${herit}_cross${cross}_dist${dist}_ps${ps}
pred1=/net/mulan/disk2/yasheng/simulation2/SLM/PT/pheno_her${herit}_cross${cross}_dist${dist}_ps${ps}
...
rm ${pred1}.log
rm ${pred1}.nopred
r21=/net/mulan/disk2/yasheng/simulation2/SLM/PT/r2_her${herit}_cross${cross}_dist${dist}_ps${ps}
Rscript ${simpred} --pheno ${pred1}.profile --r2 ${r21}_p${p}.txt
rm ${pred1}.profile
done
pbestf1=/net/mulan/disk2/yasheng/simulation2/SLM/PT/pbest1_her${herit}_cross${cross}_dist${dist}_ps${ps}
pbestf2=/net/mulan/disk2/yasheng/simulation2/SLM/PT/pbest2_her${herit}_cross${cross}_dist${dist}_ps${ps}
...
## SLMM
tmpPath=/net/mulan/disk2/yasheng/simulation2/SLM/slmm/
outPath=/net/mulan/disk2/yasheng/simulation2/SLM/slmm/
...
est2=/net/mulan/disk2/yasheng/simulation2/SLM/slmm/esteff_summary_her${herit}_cross${cross}_dist${dist}_ps${ps}.assoc
pred2=/net/mulan/disk2/yasheng/simulation2/SLM/slmm/pheno_her${herit}_cross${cross}_dist${dist}_ps${ps}
...
est200=/net/mulan/disk2/yasheng/simulation2/SLM/sblup/esteff_her${herit}_cross${cross}_dist${dist}_ps${ps}_200
# est1000=/net/mulan/disk2/yasheng/simulation2/SLM/sblup/esteff_her${herit}_cross${cross}_dist${dist}_ps${ps}_1000
...
pred3200=/net/mulan/disk2/yasheng/simulation2/SLM/sblup/pheno_her${herit}_cross${cross}_dist${dist}_ps${ps}_200
# pred31000=/net/mulan/disk2/yasheng/simulation2/SLM/sblup/pheno_her${herit}_cross${cross}_dist${dist}_ps${ps}_1000
...
coord1=/net/mulan/disk2/yasheng/simulation2/SLM/ldpred/summary_cv_her${herit}_cross${cross}_dist${dist}_ps${ps}.HDF5
${py} ${ldpred} coord --gf ${bfileval} --ssf ${summf}_LDpred.sumstat --out ${coord1} --N ${n} --ssf-format STANDARD --max-freq-discrep 0.2
ldest=/net/mulan/disk2/yasheng/simulation2/SLM/ldpred/ld_her${herit}_cross${cross}_dist${dist}_ps${ps}
infest=/net/mulan/disk2/yasheng/simulation2/SLM/ldpred/esteff_her${herit}_cross${cross}_dist${dist}_ps${ps}
${py} ${ldpred} gibbs --cf ${coord1} --ldr ${ldr} --ldf ${ldest} --out ${infest} --N ${n} --h2 ${herit} \
--f 1 0.3 0.1 0.03 0.01 0.003 0.001 0.0003 0.0001 

pred41=/net/mulan/disk2/yasheng/simulation2/SLM/ldpred/pheno_her${herit}_cross${cross}_dist${dist}_ps${ps}
r24=/net/mulan/disk2/yasheng/simulation2/SLM/ldpred/r2_her${herit}_cross${cross}_dist${dist}_ps${ps}
...
pbestf4=/net/mulan/disk2/yasheng/simulation2/SLM/ldpred/r2_her${herit}_cross${cross}_dist${dist}_ps${ps}_best.txt
Rscript ${max2} --r2 ${r24}_p --pbest ${pbestf4} 
pbest4=`cat ${pbestf4}`

coord2=/net/mulan/disk2/yasheng/simulation2/SLM/ldpred/summary_ref_her${herit}_cross${cross}_dist${dist}_ps${ps}.HDF5
...
predInf4=/net/mulan/disk2/yasheng/simulation2/SLM/ldpred/pheno_her${herit}_cross${cross}_dist${dist}_ps${ps}_inf
predp4=/net/mulan/disk2/yasheng/simulation2/SLM/ldpred/pheno_her${herit}_cross${cross}_dist${dist}_ps${ps}_pbest
...
## lassosum
res5=/net/mulan/disk2/yasheng/simulation2/SLM/lassosum/res_her${herit}_cross${cross}_dist${dist}_ps${ps}
