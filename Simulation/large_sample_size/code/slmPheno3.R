...
snp_info_str <- "/net/mulan/disk2/yasheng/plink_file/simulation/sim_large_sub"

##
geno_str <- paste0(opt$path, "geno_her", opt$herit, "_cross", opt$cross, "_dist", opt$dist, "_ps", opt$p)
eff_str <- paste0(opt$path, "eff_her", opt$herit, "_cross", opt$cross, "_dist", opt$dist, "_ps", opt$p,".txt")
pheno_str <- paste0(opt$path, "pheno_her", opt$herit, "_cross", opt$cross, "_dist", opt$dist, "_ps", opt$p)
