...
#SBATCH --job-name=ldpredO
#SBATCH --mem=12G
#SBATCH --cpus-per-task=1

#SBATCH --array=1-5
#SBATCH --output=/net/mulan/disk2/yasheng/out/ldpredO_%a.out
#SBATCH --error=/net/mulan/disk2/yasheng/err/ldpredO_%a.err
...
coord1=/net/mulan/disk2/yasheng/out_sample/pheno${PHENO}/ldpred/summary_cv_cross${cross}.HDF5
${py} ${ldpred} coord --gf ${sub} --ssf ${summ}_LDpred.sumstat --out ${coord1} --N ${n} --ssf-format STANDARD --max-freq-discrep 0.2
ldest=/net/mulan/disk2/yasheng/out_sample/pheno${PHENO}/ldpred/ld_cross${cross}_ldr${ldr}
infest=/net/mulan/disk2/yasheng/out_sample/pheno${PHENO}/ldpred/esteff_cross${cross}_ldr${ldr}
${py} ${ldpred} gibbs --cf ${coord1} --ldr ${ldr} --ldf ${ldest} --out ${infest} --N ${n} --h2 ${h2} --f 1 0.3 0.1 0.03 0.01 0.003 0.001 0.0003 0.0001 

## cross validation
pred=/net/mulan/disk2/yasheng/out_sample/pheno${PHENO}/ldpred/pheno_cross${cross}
r2=/net/mulan/disk2/yasheng/out_sample/pheno${PHENO}/ldpred/r2_cross${cross}
...
pbestf=/net/mulan/disk2/yasheng/out_sample/pheno${PHENO}/ldpred/r2_cross${cross}_pbest.txt
...
coord2=/net/mulan/disk2/yasheng/out_sample/pheno${PHENO}/ldpred/summary_ref_cross${cross}_ldr${ldr}.HDF5
