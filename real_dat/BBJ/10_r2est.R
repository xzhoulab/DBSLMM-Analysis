...
eff_PT_str <- paste0("/net/mulan/disk2/yasheng/out_bbj/pheno", opt$pheno, "/PT/summary_cross", opt$cross, "_best_chr")
eff_SBSLMM_str <- paste0("/net/mulan/disk2/yasheng/out_bbj/pheno", opt$pheno, "/slmm/esteff_summary_cross", opt$cross, "_chr")
eff_SBLUP_str <- paste0("/net/mulan/disk2/yasheng/out_bbj/pheno", opt$pheno, "/sblup/esteff_cross", opt$cross, "_chr")
eff_ldpredinf_str <- paste0("/net/mulan/disk2/yasheng/out_bbj/pheno", opt$pheno, "/ldpred/esteff_cross", opt$cross, "_ldr200_inf_chr")
eff_ldpredpbest_str <- paste0("/net/mulan/disk2/yasheng/out_bbj/pheno", opt$pheno, "/ldpred/esteff_cross", opt$cross, "_ldr200_pbest_chr")
...
LD_path <- "/net/mulan/disk2/yasheng/EAS/LDmat/"
chr_block_str <- "/net/mulan/home/yasheng/Biobank/data/LDblock_EAS/chr"
### out summary statistics
summ_out <- data.frame(fread(paste0("/net/mulan/disk2/yasheng/out_bbj/raw_data/pheno", opt$pheno, "_scale.txt.gz")))
...
if (opt$method == "PT"){
  ...
  write.table(cbind(nume, deno),
              file = paste0("/net/mulan/disk2/yasheng/out_bbj/pheno", opt$pheno, "/r2/PT_cross", opt$cross, "_chr", chr, ".txt"),
...
if (opt$method == "DBSLMM"){
  ...
  write.table(cbind(nume, deno),
              file = paste0("/net/mulan/disk2/yasheng/out_bbj/pheno", opt$pheno, "/r2/DBSLMM_cross", opt$cross, "_chr", chr, ".txt"),
              row.names = F, col.names = F, quote = F)
}
...
if (opt$method == "SBLUP"){
  ...
  write.table(cbind(nume, deno),
              file = paste0("/net/mulan/disk2/yasheng/out_bbj/pheno", opt$pheno, "/r2/SBLUP_cross", opt$cross, "_chr", chr, ".txt"),
              row.names = F, col.names = F, quote = F)
}

### lassosum
if (opt$method == "lassosum"){
  load(paste0("/net/mulan/disk2/yasheng/out_bbj/pheno", opt$pheno, "/lassosum/esteff_cross", opt$cross, ".RData"))
  ...
  cat("chr: ", chr, "\n")
  write.table(cbind(nume, deno),
              file = paste0("/net/mulan/disk2/yasheng/out_bbj/pheno", opt$pheno, "/r2/lassosum_cross", opt$cross, "_chr", chr, ".txt"),
              row.names = F, col.names = F, quote = F)
}
...
if (opt$method == "ldpredinf"){
  ...
  cat("chr: ", chr, "\n")
  write.table(cbind(nume, deno),
              file = paste0("/net/mulan/disk2/yasheng/out_bbj/pheno", opt$pheno, "/r2/ldpredinf_cross", opt$cross, "_chr", chr, ".txt"),
              row.names = F, col.names = F, quote = F)
}
...
if (opt$method == "ldpredpbest"){
  ...
  write.table(cbind(nume, deno),
              file = paste0("/net/mulan/disk2/yasheng/out_bbj/pheno", opt$pheno, "/r2/ldpredpbest_cross", opt$cross, "_chr", chr, ".txt"),
              row.names = F, col.names = F, quote = F)
}
