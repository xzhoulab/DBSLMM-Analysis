...
#### use subset
## to plink format
summf=/net/mulan/disk2/yasheng/out_bbj/pheno${PHENO}/summ/summary_cross${cross}
for ((chr=1;chr<23;chr++));do
Rscript ${toplinkf} --gemma ${summf}_chr${chr}.assoc.txt --plink ${summf}_chr${chr}.plink.txt
done

### different cutoff values
clump=/net/mulan/disk2/yasheng/out_bbj/pheno${PHENO}/PT/summary_cross${cross}
pred=/net/mulan/disk2/yasheng/out_bbj/pheno${PHENO}/PT/pheno_cross${cross}
r2=/net/mulan/disk2/yasheng/out_bbj/pheno${PHENO}/PT/r2_cross${cross}
...
# best p value
pbestf=/net/mulan/disk2/yasheng/out_bbj/pheno${PHENO}/PT/pbest_cross${cross}
