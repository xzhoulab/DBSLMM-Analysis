...
for PHENO in 10; do
for cross in 2 ; do
for chr in 1 2 3 4 5 6 7 8 10 11; do
let k=${k}+1
...
## est
summ=/net/mulan/disk2/yasheng/out_bbj/pheno${PHENO}/summ/summary_cross${cross}_chr${chr}
...
est=/net/mulan/disk2/yasheng/out_bbj/pheno${PHENO}/sblup/esteff_cross${cross}_chr${chr}
